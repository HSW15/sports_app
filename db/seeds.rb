...
ActiveRecord::Base.transaction do
  # 8 Listings
    ...
    ", price: 0, max_guests: 1, purpose: "train", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/train4.jpg" )

    Listing.create(name: "Rev Republic Fitness", location:"35 jalan ss23/15 Taman SEA petaling jaya, Malaysia", description:"Join our fun loving community in awesome workouts led by our team of experienced coaches that brings a true revelation of your physical and mental potential, exclusively here at the Republic.", price: 0, max_guests: 1, purpose: "train", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/train5.jpg" )

    # 5 Nutrition
    # Listing.create(...purpose:"nutrition")
    Listing.create(name: "Healthy Life House", location:"S12 & S31, 2nd Floor, Lot10 Shopping Center,, 50, Jalan Sultan Ismail, Bukit Bintang, 50250 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur, Malaysia", description:"Find out how much you need to drink and how to choose healthier soft drinks.", price: 0, max_guests: 1, purpose: "nutrition", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/nutrition1.jpg" )

    Listing.create(name: "Ashley's by Living Food", location:" 11, Jalan Telawi 3, Bangsar Baru, 59100 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur, Malaysia", description:"Calories mean energy, and the right energy balance is the key to a healthy weight.", price: 0, max_guests: 1, purpose: "nutrition", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/nutrition2.jpg" )

    Listing.create(name: "HALE, Healthy Fast Food", location:" G-39, Wisma MPL, Jalan Raja Chulan, Wisma MPL, 50200 Kuala Lumpur, Federal Territory of Kuala Lumpur, Malaysia", description:"Many of us are eating too much and not being active enough. Find out how to cut the calories.", price: 0, max_guests: 1, purpose: "nutrition", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/nutrition3.jpg" )

    Listing.create(name: "Salad Atelier", location:"30, Jalan Prima 1, Metro Prima, Willayah Persekutuan, Kepong, 52100, Malaysia", description:"To get the balance of your diet right, use the Eatwell Guide. It shows how much you should eat from each food group.", price: 0, max_guests: 1, purpose: "nutrition", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/nutrition5.jpg" )

    Listing.create(name: "Be Lohas Healthy Cuisine", location:"Jalan Batu Ambar, Taman Kok Lian, 51200 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur, Malaysia", description:"Find out about the role fats play in a healthy diet, including saturated fats and unsaturated fats.", price: 0, max_guests: 1, purpose: "nutrition", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/nutrition4.jpg" )

    # 10 listing place for purpose visit
    Listing.create(name: "Genting Highland", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit1.jpg", purpose: "visit" )

    Listing.create(name: "Batu Caves", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit2.jpg", purpose: "visit" )

    Listing.create(name: "Penang", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit3.jpg", purpose: "visit" )

    Listing.create(name: "Melaka", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit4.jpg", purpose: "visit" )

    Listing.create(name: "Gunung Kinabalu", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit5.jpg", purpose: "visit" )

    Listing.create(name: "Kuala Lumpur Convention Center", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit6.jpg", purpose: "visit" )

    Listing.create(name: "Sunway Lagoon", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit7.png", purpose: "visit" )

    Listing.create(name: "Redang Island", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit8.jpg", purpose: "visit" )

    Listing.create(name: "Ipoh", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit9.jpg", purpose: "visit" )

    Listing.create(name: "Cameron highland", photos: "https://s3-ap-southeast-1.amazonaws.com/johnsoo/sportsapp/visit10.jpg", purpose: "visit" )
